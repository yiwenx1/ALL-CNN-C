...
if __name__ == '__main__':
    ...
    train_feats = np.random.rand(100, 3072)
    train_labels = np.random.randint(low=0, high=9, size=(100,))
    test_feats = np.random.rand(50, 3072)

    np.save("./dataset/train_feats_toy.npy", train_feats)
    np.save("./dataset/train_labels_toy.npy", train_labels)
    np.save("./dataset/test_feats_toy.npy", test_feats)
